...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // ordena por palo de cartas
        System.out.println("Ordena por palo naipe");
        System.out.println("-----------------------");
        ...
        System.out.println("\nOrdena por valor naipe");
        System.out.println("-----------------------");

        // ordena por valor Cartas
        // Tambien se puede crear de este modo el objeto  
